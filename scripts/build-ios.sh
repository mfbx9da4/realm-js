...
SDKROOT="${SDK_ROOT_OVERRIDE:-/Applications/Xcode-12.4.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/}" cmake "$PROJECT_ROOT" -GXcode \
...
DEVELOPER_DIR="${DEVELOPER_DIR_OVERRIDE:-/Applications/Xcode-12.4.app}" xcodebuild build \
    -scheme realm-js-ios \
    "${DESTINATIONS[@]}" \
